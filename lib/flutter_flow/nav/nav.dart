...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const OnbWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/conncectedDvcs',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'ConncectedDvcs')
              : const ConncectedDvcsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Settings1Notifications')
              : const Settings1NotificationsWidget(),
        ),
        FFRoute(
          name: 'CreateAccount1',
          path: '/createAccount1',
        ...
        FFRoute(
          name: 'onb',
          path: '/onb',
          builder: (context, params) => const OnbWidget(),
        )
